const routes = [
  {
    ...
    children: [
      ...
      { path: 'tdcencoding20', meta: { title: 'Encoding 2.0 - InteractionFree View' }, component: () => import('pages/TDCEncoding20.vue') },
      { path: 'process', meta: { title: 'Process - InteractionFree View' }, component: () => import('pages/TFProcess.vue') },
